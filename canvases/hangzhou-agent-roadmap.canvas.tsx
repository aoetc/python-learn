...
const DAY_SCRIPT: {
  ...
  },
  {
    ...
    minutes: "90",
    liao: "面向对象：类和实例（第一天）",
    doNow: "看懂 class / __init__ / self；做 notes/lesson14 选择+判断；写 ex01_student。",
    git: "Commit。",
  },
  {
    id: "d16",
    ...
    when: "第 3 周",
    minutes: "90",
    liao: "面向对象：类和实例（第二天，仍是这一块）",
    doNow: "做完 lesson14 编程 ex02/ex03（is_pass、LedgerEntry）；访问限制/多态只略读。搞清：方法要 ()；return 后外面 print。",
    git: "Commit 测验和练习。",
  },
  {
    id: "d17",
    ...
    when: "第 4 周",
    minutes: "90",
    liao: "JSON：dumps/loads（字符串）与 dump/load（文件）",
    doNow: "dict ↔ JSON 字符串；用 json 读写一个 .json 小文件。跳过函数式/元类/线程/GUI/Web/异步。",
    git: "Commit 笔记或 exercises/lesson15（若已建）。",
  },
  {
    id: "d18",
    day: "第 18 天",
    ...
    minutes: "90",
    liao: "JSON + 文件巩固",
    doNow: "小脚本：读 JSON 列表 → 改一条 → 写回。继续跳过函数式等章节。",
    git: "Commit。",
  },
  {
    id: "d19",
    ...
    minutes: "90",
    liao: "不新开大章；开始小项目骨架",
    doNow: "建 dca-ledger（独立仓库或本仓子目录）：README、.gitignore、venv、能跑的空入口（打印用法即可）。",
    git: "Commit：scaffold。不要提交 .venv。",
  },
  {
    id: "d20",
    day: "第 20 天",
    ...
    minutes: "90",
    liao: "无新章",
    doNow: "实现 add：输入日期和金额，追加一行到 CSV（date,amount）。",
    git: "Commit：add writes CSV。样例可交；勿交真实账单。",
  },
  {
    id: "d21",
    day: "第 21 天",
    ...
    minutes: "90",
    liao: "无新章",
    doNow: "实现 list：读 CSV 并打印；文件不存在用 try/except。README 写清三步用法。",
    git: "Commit + Push。别人按 README 能跑到 list。",
  },
  {
    id: "d22",
    day: "第 22 天",
    ...
    minutes: "90",
    liao: "无新章",
    doNow: "dca-ledger：加 summary（或 total）——读 CSV，打印笔数和金额合计。非法行跳过或提示，不闪退。",
    git: "Commit：summary command。",
  },
  {
    id: "d23",
    day: "第 23 天",
    ...
    minutes: "90",
    liao: "无新章",
    doNow: "dca-ledger：按日期筛选 list（例如只看某一天），或简单 delete 最后一行。先做一种即可。",
    git: "Commit。",
  },
  {
    id: "d24",
    ...
    when: "第 5 周",
    minutes: "90",
    liao: "无新章；对照阶段 A「问题拆解」",
    doNow: "在 README 写 5 条验收：能 add / list / 文件缺失怎么办 / 非数字金额怎么办 / 别人怎么安装运行。",
    git: "Commit：README 验收清单。",
  },
  {
    id: "d25",
    day: "第 25 天",
    ...
    minutes: "90",
    liao: "不看新章",
    doNow: "力扣简单哈希/数组题 1 道写在 algo/；再翻 notes/复习_错题与存疑.md 口述 3 条薄弱点。",
    git: "Commit 算法题。",
  },
  {
    id: "d26",
    ...
    minutes: "90",
    liao: "JSON 复习（不新开大章）",
    doNow: "小练习：CSV 样例 ↔ JSON 列表互转（读一种格式，写出另一种）。可放 exercises/ 或 dca-ledger/tools。",
    git: "Commit。",
  },
  {
    id: "d27",
    ...
    minutes: "90",
    liao: "无新章",
    doNow: "整理项目结构：数据放到 data/（如 data/ledger.csv）；代码里用相对路径；更新 README。",
    git: "Commit：data/ 布局。样例 CSV 可交，真实账单不交。",
  },
  {
    id: "d28",
    day: "第 28 天",
    ...
    minutes: "90",
    liao: "无新章；命令行入门",
    doNow: "用 sys.argv（或极简 argparse）支持：python main.py add ... / list，少靠反复 input。",
    git: "Commit：CLI argv。",
  },
  {
    id: "d29",
    ...
    minutes: "90",
    liao: "无新章；小测试",
    doNow: "给「解析一行 CSV / 合计金额」写 2～3 个 assert 或手工测试函数，跑通再改功能。",
    git: "Commit：tiny tests。",
  },
  {
    id: "d30",
    day: "第 30 天",
    ...
    minutes: "120",
    liao: "不学新章",
    doNow: "从零克隆/打开项目，按 README 三步跑通 add+list+summary。记下卡点并修好。",
    git: "Commit + Push。确认 GitHub 网页 README 最新。",
  },
  {
    id: "d31",
    day: "第 31 天",
    ...
    minutes: "90",
    liao: "无新章；Git 习惯",
    doNow: "搞清：日常只用 main；乱分支会找不到课。检查 .gitignore（.venv、__pycache__）。口头说清 Commit vs Push。",
    git: "有改动就 Commit；保持 main 干净。",
  },
  {
    id: "d32",
    day: "第 32 天",
    ...
    minutes: "90",
    liao: "不看新章",
    doNow: "algo/ 再做 1 道简单题（或重做两数之和/有效括号不看答案）。对照错题本。",
    git: "Commit。",
  },
  {
    id: "d33",
    ...
    minutes: "90",
    liao: "无新章；可读性",
    doNow: "给 dca-ledger 关键函数/文件（例如 csv_io.py）；函数要有简短注释；保证还能跑。",
    git: "Commit：refactor for readability。",
  },
  {
    id: "d34",
    day: "第 34 天",
    ...
    minutes: "90",
    liao: "无新章；阶段 A 收口",
    doNow: "写一页「别人 5 分钟能跑」：环境、命令、样例输出、常见报错。对照 roadmap 阶段 A 出口勾选。",
  ...
  },
  {
    ...
    when: "第 8 周初 · 缓冲/衔接",
    minutes: "90",
    liao: "可选：requests 请求一个公开 JSON API 并打印（为阶段 B 铺垫）；或纯复习薄弱点",
    doNow: "二选一：① venv 里 pip install requests，GET 一个公开接口打印字段；② 错题本口述 + 重做 1 道旧编程题。",
    git: "有代码就 Commit；不要提交密钥。下一阶段再开「最小 Agent」。",
  },
];
